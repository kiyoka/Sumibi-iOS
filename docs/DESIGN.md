...
6. ✅ OpenAI互換APIとの連携
7. ✅ Undo、キャンセル、エラー処理
8. ⚠️ 初期設定、プライバシー説明、実機検証（実機へのインストールと操作確認待ち）
...
- 接続端末: iPhone 14 Plus を認識
- 未完了: 署名済みアプリの実機インストール、キーボード有効化、変換通信の操作確認

実機検証を続けるには、XcodeでApple Developmentの署名証明書を用意し、
アプリ本体とキーボード拡張の両ターゲットにDevelopment Teamを設定する。
